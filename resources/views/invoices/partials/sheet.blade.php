{{-- ใบแจ้งหนี้ 1 ใบ - ใช้ร่วมกันทั้ง invoices/print.blade.php (พิมพ์ใบเดียว) และ
     tenant-invoices/print-bulk.blade.php (พิมพ์รวมหลายใบเป็น PDF เดียว) ต้องรับ $invoice/$company/$happyestPublic
     เหมือนกันทุกจุดที่ include --}}
@php
